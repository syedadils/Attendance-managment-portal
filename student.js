...
function displayFun(studentDataArr) {
    ...
    studentDataArr.map(function (item) {
        ...
        td6.innerHTML=item.fname;
        var td7 = document.createElement("td")
        td7.innerHTML=item.course;
        var td8 = document.createElement("td")
        td8.innerHTML=item.batch;
        var td9 = document.createElement("td");
        var btn1 = document.createElement("button");
        btn1.innerHTML = "P";
        btn1.addEventListener("click", function () {
            td9.innerHTML = "<button >Present</button>";
        });
        var btn2 = document.createElement("button");
        btn2.innerHTML = "A";
        btn2.addEventListener("click", function () {
            td9.innerHTML = "<button id='absent'>Absent</button>";
        
        });
        td9.classList.add("td9");
        td9.append(btn1, btn2);
